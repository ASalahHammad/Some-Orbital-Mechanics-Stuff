...
tfinal = 365.25*23.9*3600; % 1*12*30*24*3600; % 67000;
dt = 10;
t = 0:dt:tfinal;

%% Bodies Data
obj1.filename = "./Images/sun.png";
obj1.radius = 696e6 * 15;
r1_0 = [0; 0; 0];
v1_0 = [0e3; 0e3; 0e3];
m1 = 1.989e30; % [Kg]

obj2.filename = "./Images/mercury.png";
obj2.radius = 2440e3 * 800;
...
states_0 = [r1_0; r2_0; r3_0; r4_0; v1_0; v2_0; v3_0; v4_0];
mass_vec = [m1, m2, m3, m4];
...
simulate(t, 50000, R, V, A, ["r", "g", "b", "m", "k--"], ["Sun", "Mercury", "venus", "Earth", "CG"], ax1, obj_vec);
